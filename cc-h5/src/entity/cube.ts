...
class Unit implements IUnit
{
    ...
    constructor(
        ...
        y: number,
        public owner: ICube,
        private readonly layer: ReadonlyArray<egret.DisplayObjectContainer>)
    {
        ...
        private readonly layer: ReadonlyArray<egret.DisplayObjectContainer>)
    {
        ...
        for (const part of this.parts) {
            ...
            egret.Tween
                ...
                .to({alpha: 0.4}, 3000, egret.Ease.sineInOut)
                ;
        }
...
export class CubeFactory
{
    ...
    create(src: Seed.Cube|Seed.Vec2): Cube|Dest
    {
        if (Array.isArray(src)) {
            const dest = new Dest(src[0], src[1], this.world, this.layer);
            return dest;
        } else {
